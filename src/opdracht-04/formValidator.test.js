...
describe('Form Validator', () => {
  ...
  test('isValidEmail weigert email zonder @', () => {
    ...
    expect(isValidEmail('testexample.com')).toBe(false); // Deze test faalt! Vervang met je eigen test
  });

  test('isValidPhone accepteert 06 nummer', () => {
    // TODO: Test of '0612345678' geldig is
    expect(isValidPhone('0612345678')).toBe(true); // Deze test faalt! Vervang met je eigen test
  });

  test('isValidPhone accepteert nummer met streepjes', () => {
    // TODO: Test of '06-1234-5678' geldig is
    expect(isValidPhone('06-1234-5678')).toBe(true); // Deze test faalt! Vervang met je eigen test
  });

  test('isValidPostcode accepteert postcode met spatie', () => {
    // TODO: Test of '1234 AB' geldig is
    expect(isValidPostcode('1234 AB')).toBe(true); // Deze test faalt! Vervang met je eigen test
  });

  test('isValidPostcode accepteert postcode zonder spatie', () => {
    // TODO: Test of '1234AB' geldig is
    expect(isValidPostcode('1234AB')).toBe(true); // Deze test faalt! Vervang met je eigen test
  });
  ...
  test('validateForm geeft errors bij ongeldig formulier', () => {
    ...
    expect(validateForm({ ...testData, email: 'invalid-email' }).isValid).toBe(false); // Deze test faalt! Vervang met je eigen test
    expect(validateForm({ ...testData, email: 'invalid-email' }).errors).toHaveLength(1);
  });
